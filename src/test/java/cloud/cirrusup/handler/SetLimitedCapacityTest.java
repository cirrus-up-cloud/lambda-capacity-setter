...
public class SetLimitedCapacityTest {

    private SetLimitedCapacity setter;
    ...
    public void testInvalidParams() {
        ...
        when(SystemPropertiesUtils.hasPropertySet("aws.accessKeyId")).thenReturn(false);
    ...
    public void testComplete() {
        ...
        when(specification.getCpuCredits()).thenReturn("unlimited");
